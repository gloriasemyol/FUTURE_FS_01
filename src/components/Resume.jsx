  ...
  return (
    <section id="resume" className="py-24 px-6 bg-violet-50 dark:bg-[#150c28]">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <h2 className="text-3xl md:text-4xl font-extrabold mb-10 text-gray-900 dark:text-white">
          My{" "}
        ...
        <a
          ...
          className="inline-flex items-center gap-2 mt-8 px-6 py-3 rounded-full bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-medium shadow-lg shadow-violet-300/50 dark:shadow-violet-900/50 hover:scale-105 transition-transform"
        >

  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mb-6">
        <div className="w-36 h-36 rounded-full bg-gradient-to-r from-violet-600 to-fuchsia-600 p-1">
          <img
            src={profilePhoto}
            alt="Gloria"
      ...
      {/* Intro Subtitle */}
      <p className="relative z-10 text-violet-600 dark:text-violet-400 font-medium mb-3 tracking-wide">
        👋 Hi, my name is
      </p>

      {/* Main Title */}
      <h1 className="relative z-10 text-4xl md:text-6xl font-extrabold mb-4 bg-gradient-to-r from-violet-600 via-fuchsia-600 to-violet-600 bg-clip-text text-transparent">
        Gloria
      </h1>

      {/* Profession */}
      <h2 className="relative z-10 text-xl md:text-2xl font-semibold text-gray-700 dark:text-gray-200 mb-6">
        Full Stack Web Developer
      </h2>

      {/* Short Bio */}
      <p className="relative z-10 max-w-xl text-gray-500 dark:text-gray-400 mb-8">
      ...
      <div className="relative z-10 flex flex-wrap gap-4 justify-center mb-8">
        <a
          href="#projects"
          className="px-6 py-3 rounded-full bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-medium shadow-lg shadow-violet-300/50 dark:shadow-violet-900/50 hover:scale-105 transition-transform"
        >
          View My Projects
        </a>
        ...
        <a
          ...
          className="px-6 py-3 rounded-full border-2 border-violet-600 text-violet-600 dark:text-violet-400 dark:border-violet-400 font-medium hover:bg-violet-50 dark:hover:bg-violet-900/30 transition-colors"
        >
          Download Resume
        </a>
      </div>
